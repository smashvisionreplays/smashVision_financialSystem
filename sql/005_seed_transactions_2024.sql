...
VALUES ('2024-03-01', 'expense', 60.00, 'USD', 1, 60.00, 'Cámara IP', 'Primer intento de cámara',
  NULL,
  (SELECT id FROM finance_people WHERE name = 'César Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Infrastructure' AND type = 'expense'));
...
VALUES ('2024-04-01', 'expense', 12.32, 'USD', 1, 12.32, 'AWS', NULL,
  NULL,
  (SELECT id FROM finance_people WHERE name = 'César Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Services' AND type = 'expense'));
...
VALUES ('2024-04-01', 'expense', 15.00, 'USD', 1, 15.00, 'Ubers', NULL,
  NULL,
  (SELECT id FROM finance_people WHERE name = 'César Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Transportation' AND type = 'expense'));
...
VALUES ('2024-05-01', 'expense', 14.54, 'USD', 1, 14.54, 'AWS', NULL,
  NULL,
  (SELECT id FROM finance_people WHERE name = 'Amazon'),
  (SELECT id FROM finance_categories WHERE name = 'Services' AND type = 'expense'));
...
VALUES ('2024-06-01', 'expense', 60.00, 'USD', 1, 60.00, 'Cámara Hikvision', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'Tomás Ossa'),
  (SELECT id FROM finance_categories WHERE name = 'Infrastructure' AND type = 'expense'));
...
VALUES ('2024-06-01', 'expense', 25.00, 'USD', 1, 25.00, 'Cables ETH', NULL,
  NULL,
  (SELECT id FROM finance_people WHERE name = 'Tomás Ossa'),
  (SELECT id FROM finance_categories WHERE name = 'Materials' AND type = 'expense'));
...
VALUES ('2024-07-01', 'expense', 25.00, 'USD', 1, 25.00, 'Envío de Cámaras', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'César Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Shipping' AND type = 'expense'));
...
VALUES ('2024-08-01', 'expense', 10.00, 'USD', 1, 10.00, 'Cloudflare', NULL,
  NULL,
  (SELECT id FROM finance_people WHERE name = 'Julio Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Services' AND type = 'expense'));
...
VALUES ('2024-08-01', 'expense', 200.00, 'USD', 1, 200.00, 'PC', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'Julio Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Equipment' AND type = 'expense'));
...
VALUES ('2024-09-01', 'expense', 8.00, 'USD', 1, 8.00, 'Canaletas', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'Juan Ossa'),
  (SELECT id FROM finance_categories WHERE name = 'Materials' AND type = 'expense'));
...
VALUES ('2024-09-01', 'expense', 257.00, 'USD', 1, 257.00, 'Instalación Cámara 7', 'Cámara 7 Padel Nation',
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'Juan Ossa'),
  (SELECT id FROM finance_categories WHERE name = 'Installation' AND type = 'expense'));
...
VALUES ('2024-09-01', 'expense', 91.00, 'USD', 1, 91.00, 'Instalación Cámara 8', 'Cámara 8 Padel Nation',
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'Paola Marin'),
  (SELECT id FROM finance_categories WHERE name = 'Installation' AND type = 'expense'));
...
INSERT INTO finance_transactions (date, type, original_amount, original_currency, exchange_rate, usd_amount, description, notes, club_id, person_id, category_id)
VALUES ('2024-10-01', 'expense', 110.00, 'USD', 1, 110.00, 'Envío de cámaras', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Smash Padel'),
  (SELECT id FROM finance_people WHERE name = 'César Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Shipping' AND type = 'expense'));

INSERT INTO finance_transactions (date, type, original_amount, original_currency, exchange_rate, usd_amount, description, notes, club_id, person_id, category_id)
VALUES ('2024-10-01', 'expense', 50.00, 'USD', 1, 50.00, 'Aduana cámaras', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Smash Padel'),
  (SELECT id FROM finance_people WHERE name = 'César Castaño'),
  (SELECT id FROM finance_categories WHERE name = 'Shipping' AND type = 'expense'));

INSERT INTO finance_transactions (date, type, original_amount, original_currency, exchange_rate, usd_amount, description, notes, club_id, person_id, category_id)
VALUES ('2024-10-01', 'expense', 188.00, 'USD', 1, 188.00, '4 Cámaras', 'Club: Smash Padel, Padeling',
  NULL,
  (SELECT id FROM finance_people WHERE name = 'Tomás Ossa'),
  (SELECT id FROM finance_categories WHERE name = 'Infrastructure' AND type = 'expense'));
...
VALUES ('2024-12-01', 'expense', 16.56, 'USD', 1, 16.56, 'IVA Pago Diciembre', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'Smash Vision'),
  (SELECT id FROM finance_categories WHERE name = 'Taxes' AND type = 'expense'));
...
VALUES ('2024-12-01', 'income', 207.00, 'USD', 1, 207.00, 'Pago Cámara 7, 8', NULL,
  (SELECT id FROM finance_clubs WHERE name = 'Padel Nation'),
  (SELECT id FROM finance_people WHERE name = 'Smash Vision'),
  (SELECT id FROM finance_categories WHERE name = 'Camera Service' AND type = 'income'));
